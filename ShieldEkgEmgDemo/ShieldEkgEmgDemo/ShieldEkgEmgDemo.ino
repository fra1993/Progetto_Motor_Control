...
void Timer2_Overflow_ISR()
{
  ...
  for(CurrentCh=0;CurrentCh<6;CurrentCh++){
    ...
    TXBuf[((2*CurrentCh) + HEADERLEN)] = ((unsigned char)((ADC_Value & 0xFF00) >> 8));	// Write High Byte (finestro i primi 8 bit dell'unigned int da 16 bit. Prendo ciè solo i bit più significativi)
